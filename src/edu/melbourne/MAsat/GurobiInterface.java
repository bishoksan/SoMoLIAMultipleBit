...
//            System.out.println(" d1 d2 " + d1 + " " + d2);
    ...
    public void printGRBConstraintsName(GRBModel grbm){
        GRBConstr[] constrs= grbm.getConstrs();
        System.out.println("the size is ========================================="+constrs.length);
//        for(int i=0; i<constrs.length; i++){
//            try {
//                System.out.println("constr: "+constrs[i].get(StringAttr.ConstrName));
//            } catch (GRBException ex) {
//                ex.printStackTrace();
//            }
//        }
